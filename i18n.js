...
(function () {
  ...
  const T = {
    ...
    "Закупка": { en: "Purchasing", uk: "Закупівля", pl: "Zakup", de: "Einkauf", ro: "Achiziție", es: "Compra", tg: "Харид" },
    "товаров и оборудования": { en: "of goods and equipment", uk: "товарів та обладнання", pl: "towarów i sprzętu", de: "von Waren und Ausrüstung", ro: "de mărfuri și echipamente", es: "de bienes y equipos", tg: "молҳо ва таҷҳизот" },
    "в Европе": { en: "in Europe", uk: "в Європі", pl: "w Europie", de: "in Europa", ro: "în Europa", es: "en Europa", tg: "дар Аврупо" },
    "в Евросоюзе": { en: "in the European Union", uk: "в Євросоюзі", pl: "w Unii Europejskiej", de: "in der EU", ro: "în Uniunea Europeană", es: "en la Unión Europea", tg: "дар Иттиҳоди Аврупо" },
    "IT-направление": { en: "IT division", uk: "IT-напрям", pl: "Dział IT", de: "IT-Bereich", ro: "Direcția IT", es: "Área de IT", tg: "Самти IT" },
    "и лицензии ПО": { en: "and software licenses", uk: "та ліцензії ПЗ", pl: "i licencje", de: "und Software-Lizenzen", ro: "și licențe software", es: "y licencias de software", tg: "ва иҷозатномаҳои нармафзор" },
    "Удобрения и агросубстраты": { en: "Fertilizers and agro substrates", uk: "Добрива та агросубстрати", pl: "Nawozy i podłoża agro", de: "Dünger und Agrar-Substrate", ro: "Îngrășăminte și substraturi agro", es: "Fertilizantes y sustratos agro", tg: "Нуриҳо ва агросубстратҳо" },
    "из Европы": { en: "from Europe", uk: "з Європи", pl: "z Europy", de: "aus Europa", ro: "din Europa", es: "desde Europa", tg: "аз Аврупо" },
    "по Европе": { en: "across Europe", uk: "по Європі", pl: "po Europie", de: "in ganz Europa", ro: "în toată Europa", es: "por toda Europa", tg: "дар саросари Аврупо" },

    "Частые вопросы": { en: "FAQ", uk: "Часті питання", pl: "Najczęstsze pytania", de: "Häufige Fragen", ro: "Întrebări frecvente", es: "Preguntas frecuentes", tg: "Саволҳои зуд-зуд" },
    "Процесс": { en: "Process", uk: "Процес", pl: "Proces", de: "Ablauf", ro: "Proces", es: "Proceso", tg: "Раванд" },
    "Цены": { en: "Pricing", uk: "Ціни", pl: "Ceny", de: "Preise", ro: "Prețuri", es: "Precios", tg: "Нархҳо" },
    "Стоимость услуг": { en: "Service pricing", uk: "Вартість послуг", pl: "Cennik usług", de: "Leistungspreise", ro: "Costul serviciilor", es: "Coste de servicios", tg: "Арзиши хидматҳо" },
    "Преимущества": { en: "Advantages", uk: "Переваги", pl: "Zalety", de: "Vorteile", ro: "Avantaje", es: "Ventajas", tg: "Бартариҳо" },
    "Услуги": { en: "Services", uk: "Послуги", pl: "Usługi", de: "Leistungen", ro: "Servicii", es: "Servicios", tg: "Хидматҳо" },
    "Продукция": { en: "Products", uk: "Продукція", pl: "Produkty", de: "Produkte", ro: "Produse", es: "Productos", tg: "Маҳсулот" },
    "Автопарк": { en: "Fleet", uk: "Автопарк", pl: "Flota", de: "Fuhrpark", ro: "Parc auto", es: "Flota", tg: "Парки нақлиёт" },
    "Каталог": { en: "Catalog", uk: "Каталог", pl: "Katalog", de: "Katalog", ro: "Catalog", es: "Catálogo", tg: "Каталог" },
    "Гарантии": { en: "Guarantees", uk: "Гарантії", pl: "Gwarancje", de: "Garantien", ro: "Garanții", es: "Garantías", tg: "Кафолатҳо" },
